#!/usr/bin/env python3
"""
CaseOh90000 v1.6.1 panel with community racing archetypes, exploding finisher preset, and a hidden Easter egg.
...
class OverlayApp(tk.Tk):
    ...
    def _collect(self) -> Dict[str, Any]:
        ...
        # Advanced float controls are intentionally hidden in v1.6.1; keep those values pinned to scanned originals.
        for key in ADVANCED_FLOAT_KEYS:
